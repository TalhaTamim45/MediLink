...
class OdooApiService {
  ...
  async getPharmacyOrders(pharmacyPartnerId) {
    return this._request('/api/mobile/orders', { pharmacy_partner_id: pharmacyPartnerId });
  }

  async register(email, password, name, phone, role = 'customer', pharmacyLicense = null, street = null) {
